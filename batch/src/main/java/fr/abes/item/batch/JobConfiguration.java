...
public class JobConfiguration {
    ...
    @Bean
    public Job jobTraiterLignerFichierSuppr(JobRepository jobRepository, @Qualifier("stepRecupererNextDemandeSuppr") Step step1, @Qualifier("stepLireLigneFichier") Step step2, @Qualifier("stepAuthentifierSurSudoc") Step step3) {
