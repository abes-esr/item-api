package fr.abes.item.web.web.impl;

import com.fasterxml.jackson.databind.ObjectMapper;
import fr.abes.item.core.entities.item.Utilisateur;
import fr.abes.item.core.service.UtilisateurService;
import fr.abes.item.web.dto.DtoBuilder;
import fr.abes.item.web.exception.RestResponseEntityExceptionHandler;
import fr.abes.item.web.security.CheckAccessToServices;
import fr.abes.item.web.web.UtilisateurRestService;
