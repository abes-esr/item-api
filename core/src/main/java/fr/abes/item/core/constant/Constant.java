...
public class Constant implements Serializable {
	...
	public static final String ERR_FILE_WRONGCONTENT_DATA_WITHTITLETOOLONG = "Présence de lignes dans votre fichier avec des titres qui excèdent 255 caractères.";
